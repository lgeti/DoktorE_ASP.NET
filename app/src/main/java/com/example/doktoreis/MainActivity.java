...
public class MainActivity extends AppCompatActivity {
    ...
    private String url = "https://doktore.azurewebsites.net/api/PatientsAPI";

    public static final String EXTRA_MESSAGE = "com.example.doktoreis.MESSAGE";

    public void addPatientActivity (View view) {
        Intent intent = new Intent(this,AddPatientActivity.class);
        String message = "Dodaj pacienta v seznam.";
        ...
        public void onResponse(JSONArray response){
            ...
            for (int i = 0; i < response.length(); i++){
                try {
                    ...
                    String zzzs = object.getString("zzzs");

                    data.add(name + " " + surname + " ZZZS: " + zzzs);
